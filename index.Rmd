---
title: "Portfolio Computational Musicology: An analysis of Industrial Hip-Hop"
author: "Ben Wöltgens"
date: "March 2024"
output: 
...
```{r include=FALSE}
playlist <- get_playlist_audio_features(playlist_uris = c("3PyUBpg9MT3D3Gw6KEOB5X"))
...
<iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/3PyUBpg9MT3D3Gw6KEOB5X?utm_source=generator" width="100%" height="352" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
 <a href="https://open.spotify.com/embed/playlist/3PyUBpg9MT3D3Gw6KEOB5X?utm_source=generator">Secondary link to playlist</a> 
...
geom_point() +geom_smooth(method = "lm", se = TRUE)   + ggtitle("Industrial hip-hop artists' songs measured by Loudness and Energy") + theme(plot.title = element_text(size = 10)) + labs(x = "Energy", y="Loudness", color = "Valence")
