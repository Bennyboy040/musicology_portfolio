---
title: "Portfolio Computational Musicology Ben Wöltgens"
output: 
...
geom_point() + ggtitle("Current industrial hip-hop artists' songs measured by tempo and danceability") + theme(plot.title = element_text(size = 10)) + labs(x = "Danceability", y="Tempo", color = "Artists")
```
